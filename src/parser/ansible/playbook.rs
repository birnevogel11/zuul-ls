...
use super::tasks::parse_task_vars_internal2;
...
fn parse_playbook_role_vars_internal2(
    value: &YValue,
    path: &Path,
        ...
        for x in xs {
            ...
            for (key, value) in playbook {
                ...
                let sub_var_group: Option<VariableGroup> = match key_name {
                    ...
                    "tasks" | "pre_tasks" | "post_tasks" => {
                        parse_task_vars_internal2(value, path, "playbook", &source)
                    }
                    "roles" => parse_playbook_role_vars_internal2(value, path, &source),
                    _ => None,
                };
